...
const AUTO_INTAKE_LABELS: [string, string][] = [
  ...
  ["ownerPersonalAuto", "Owner has personal auto policy"],
  ["driverViolations", "Tickets/accidents past 3 years"],
  ["violationDetails", "Violation details"],
  ["allLicensed2Years", "All drivers US-licensed 2+ years"],
  ["otherDrivers", "Other employees/drivers"],
  ["otherDriversList", "Other employees/drivers list"],
